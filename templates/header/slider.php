	...
	foreach ( $slider_group as $slide ) {
		...
		if( $is_home ) {
			if($slide['slide_video_id']):
				$video = '<div class="video-container"><iframe src="https://www.youtube.com/embed/'.$slide['slide_video_id'].'?&autoplay=1&mute=1&playsinline=1&controls=0&&showinfo=0&loop=1&playlist='.$slide['slide_video_id'].'"></iframe></div>';
